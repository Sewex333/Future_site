        ...
        <section className="py-16 bg-black">
          <div className="max-w-4xl mx-auto px-4 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/form">
                <button className="bg-yellow-500 border-2 border-yellow-500 text-black px-8 py-3 rounded-lg font-semibold  hover:bg-black hover:text-yellow-500 transition-colors cursor-pointer">
                  Formularz
                </button>
              </Link>
              <Link to="/kontakt">
                <button className="bg-black border-2 border-yellow-500 text-yellow-500 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-500 hover:text-black transition-colors cursor-pointer">
                  Kontakt
                </button>
              </Link>
            </div>
